...
public class RecyclerItemDecoration extends RecyclerView.ItemDecoration {
    ...
    public void onDrawOver(@NonNull Canvas c, @NonNull RecyclerView parent, @NonNull RecyclerView.State state) {
        ...
        if(headerView==null)
        {
            ...
            tvTitle = (TextView)headerView.findViewById(R.id.date_header);
    ...
    {
        View view= LayoutInflater.from(context).inflate(R.layout.dashboard_single_row_date,recyclerView,false);
        return view;
    }
