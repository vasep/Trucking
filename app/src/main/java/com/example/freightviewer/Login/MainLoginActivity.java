...
public class MainLoginActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fusedLocationProviderClient = LocationServices.getFusedLocationProviderClient(MainLoginActivity.this);
...
//            Toast.makeText(getApplicationContext(), "Password needs to contain more than 6 chars...", Toast.LENGTH_SHORT).show();
    ...
    private void getUserData(String userEmail, String userPassword) {
        ...
        call.enqueue(new Callback<User>() {
            ...
            public void onResponse(Call<User> call, Response<User> response) {
                if (!response.isSuccessful()) {
                    ...
                    if (response.code() == 500) {
                        emailText.setError("");
                        Toast.makeText(MainLoginActivity.this, "Wrong username or password.", Toast.LENGTH_SHORT).show();
                    }
                    return;
                }
            ...
            Toast.makeText(MainLoginActivity.this,"Log In Failed",Toast.LENGTH_LONG).show();
            }
        });
    }
}